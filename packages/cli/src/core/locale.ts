...
export const labels = {
  "zh-TW": {
    ...
    statsOverview: "數據總覽",
    docMap: "產物關聯圖",
    coverageOverview: "覆蓋總覽",
    criteriaList: "驗收條目一覽",
    testData: "建議測試資料",
    acUiMapping: "與 UI 狀態矩陣對照",
    uiMapping: "UI 對照",
    uiOverview: "總覽",
    acCrossRef: "與驗收標準對照（建議）",
    generated: "產生時間",
    hash: "雜湊",
    statusOk: "已對齊",
    statusStale: "已過期",
  ...
  en: {
    ...
    statsOverview: "At a glance",
    docMap: "Document map",
    coverageOverview: "Coverage",
    criteriaList: "Criteria list",
    testData: "Suggested test data",
    acUiMapping: "UI matrix cross-ref",
    uiMapping: "UI mapping",
    uiOverview: "Overview",
    acCrossRef: "Acceptance criteria cross-ref",
    generated: "Generated",
    hash: "hash",
    statusOk: "ok",
    statusStale: "stale",
